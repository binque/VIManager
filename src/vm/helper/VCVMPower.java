    ...
    private Map<String, ManagedObjectReference> getVms() throws RuntimeFaultFaultMsg, InvalidPropertyFaultMsg {
        ...
        if (datacenter != null) {
            Map<String, ManagedObjectReference> datacenters =
                    VCHelper.inContainerByType(serviceContent, vimPort, container, "Datacenter");
        ...
        if (host != null) {
            ManagedObjectReference hostMoref =
                    VCHelper.inContainerByType(serviceContent, vimPort, container, "HostSystem").get(host);
            if (hostMoref == null) {
        ...
        Map<String, ManagedObjectReference> vms =
                VCHelper.inContainerByType(serviceContent, vimPort, container, "VirtualMachine");
        ...
        if (guestId != null) {
            Map<ManagedObjectReference, Map<String, Object>> vmListProp =
                    VCHelper.entityProps(serviceContent, vimPort,
